...
from threat_compare import load_ips_from_csv
...
def test_load_ips_from_csv_reads_valid_ips(tmp_path: Path):
    ...
    ips = load_ips_from_csv(str(csv_file), column_name="ips")
...
def test_load_ips_from_csv_returns_empty_for_missing_file():
    ips = load_ips_from_csv("does_not_exist.csv", column_name="ips")
